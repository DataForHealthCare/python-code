...
class AirFlowNotification:
    ...
    teams_webhook_url = "https://healthpartnersconnect.webhook.office.com/webhookb2/8e6d2cfc-f3ff-4678-ab5e-f98806ce95ef@9539230a-5213-4542-9ca6-b0ec58c41a4d/IncomingWebhook/fbf218f68dc4453f9c4885bdccb05a6b/1775bd76-474f-4197-be8c-9e2dfd57b872"
    ...
    def ms_teams_alert(context):
        teams_message = [
            ...
            {"name": "End Date", "value": "{}".format(context["ti"].end_date)},
            {
                ...
                "value": "/Repos/j7259@healthpartners.com/Data-Ingestion-Pipeline/Databricks/ProductTeam/HICORE/product/test",
            },
        ]
        teams_alert(
